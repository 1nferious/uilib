...
local library = {tabs = {}, draggable = true, flags = {}, title = 'ars.red', open = false, mousestate = true, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = 'ars_configs', fileext = '.ars'}
...
library.SettingsMenu:AddList({text = 'Background', flag = 'UI Background', values = {'Ars', 'Floral', 'Flowers', 'Circles', 'Hearts'}, callback = function(Value)
...
library.CreditSection:AddLabel('1nferious#3186 ~ main dev');
library.CreditSection:AddLabel('Scream#4766 ~ chub sux');
library.CreditSection:AddLabel('CriShoux#7827 ~ bismillah');
library.CreditSection:AddLabel('JohnGoober#0120 ~ ida');
library.CreditSection:AddLabel('chubs#1872 ~ designer');
library.CreditSection:AddLabel('zal#0010 ~ awesome :3');
library.CreditSection:AddLabel('IHaxU#4481 ~ gamer');
-- Discord
library.DiscordSection = library.SettingsColumn:AddSection('Discord');
library.DiscordSection:AddButton({text = 'Join Discord', nomouse = true, callback = function()
...
library.DiscordSection:AddButton({text = 'Copy Discord Invite', nomouse = true, callback = function()
setclipboard('discord.gg/6NNYUEXAR2')
end})